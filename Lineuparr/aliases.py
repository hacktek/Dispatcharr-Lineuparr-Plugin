...
CHANNEL_ALIASES = {
    ...
    "Sportsnet ONE": ["Sportsnet ONE", "Sportsnet 1"],
    "Sportsnet Ontario": ["Sportsnet Ontario"],
    "Sportsnet Pacific": ["Sportsnet Pacific", "Sportsnet Pacific/West"],
    "Sportsnet Pacific/West": ["Sportsnet Pacific/West", "Sportsnet Pacific"],
    "Sportsnet West": ["Sportsnet West", "Sportsnet Pacific/West"],
